    ...
    <div class="container mx-auto px-6 md:px-12 py-4">
        <div class="flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center space-x-8 text-sm">
                <a href="{{ route('home') }}" class="hover:text-black {{ request()->routeIs('home') ? 'font-bold border-b-2 border-black text-black' : '' }}">Beranda</a>
                <a href="{{ route('collection') }}" class="hover:text-black {{ request()->routeIs('collection') ? 'font-bold border-b-2 border-black text-black' : '' }}">Koleksi</a>
                <a href="{{ route('contact') }}" class="hover:text-black {{ request()->routeIs('contact') ? 'font-bold border-b-2 border-black text-black' : '' }}">Hubungi Kami</a>
                <a href="{{ route('about') }}" class="hover:text-black {{ request()->routeIs('about') ? 'font-bold border-b-2 border-black text-black' : '' }}">Tentang Kami</a>
            </nav>
                ...
                @auth
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('profile.dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Profil</a>
